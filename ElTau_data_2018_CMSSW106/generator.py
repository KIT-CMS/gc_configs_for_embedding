...
process.generator.HepMCFilter.filterParameters.ElHadCut = cms.string('El.Pt > 18 && Had.Pt > 18 && El.Eta < 2.2 && Had.Eta < 2.4')
process.generator.HepMCFilter.filterParameters.Final_States=cms.vstring('ElHad')