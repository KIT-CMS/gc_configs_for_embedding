...
--fileout PreRAWskimmed.root -n -1 --no_exec --python_filename=preselection_v2.py
...
--fileout RAWskimmed.root -n -1 --no_exec --python_filename=selection_v2.py
...
--fileout file:lhe_and_cleaned.root --runUnscheduled --data --era Run2_2016_HIPM \
...
--no_exec -n -1 --python_filename lheprodandcleaning_v2.py
...
--conditions 106X_mcRun2_asymptotic_preVFP_v11 --era Run2_2016_HIPM \
...
--beamspot Realistic25ns13TeV2016Collision --no_exec -n -1 --python_filename generator_preHLT_v2.py \
...
--fileout file:merged.root --era Run2_2016_HIPM \
