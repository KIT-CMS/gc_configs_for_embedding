...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,PAT --runUnscheduled --data --scenario pp --conditions 80X_dataRun2_2016LegacyRepro_v4 --era Run2_2016 --eventcontent RAW --datatier RAW --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2016,TauAnalysis/MCEmbeddingTools/customisers.customiseSelecting --filein file:D671E4CB-B468-E811-B0BA-FA163EFF1C10.root --fileout PreRAWskimmed.root -n -1 --no_exec --python_filename=preselection.py
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/ceph/sbrommer/2016_raw/files/EA9214E9-7B3F-E611-A512-02163E012195.root'),
