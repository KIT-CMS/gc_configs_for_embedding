...
# with command line options: RECO -s PAT --runUnscheduled --filein file:simulated_and_cleaned.root --fileout file:merged.root --era Run2_2016 --data --scenario pp --conditions 80X_dataRun2_2016LegacyRepro_v4 --era Run2_2016 --eventcontent AODSIM --datatier USER --customise TauAnalysis/MCEmbeddingTools/customisers.customiseMerging_Reselect -n -1 --no_exec --python_filename=merging_test.py
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

# In order to reduce diskusage of job, remove output of lheprodandcleaning.py
import os
