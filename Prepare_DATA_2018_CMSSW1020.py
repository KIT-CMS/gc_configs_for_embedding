...
if __name__ == "__main__":
	...
	for run in ["Run2018A","Run2018B","Run2018C"]:
		dbs_map = {}
		dbs_map["DoubleMuon_{}-v1".format(run)]="/DoubleMuon/{}-v1/RAW".format(run)
		for finalstate in final_states:
			finale_state(finalstate=finalstate, identifier="data_2018ABC_CMSSW1020", runs=[run], inputfolder="Run2018ABC_CMSSW_10_2_0", add_dbs=dbs_map, reselect=False)
