...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,PAT --runUnscheduled --data --scenario pp --conditions 80X_dataRun2_2016LegacyRepro_v4 --era Run2_2016 --eventcontent RAWRECO --datatier RAWRECO --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2016,TauAnalysis/MCEmbeddingTools/customisers.customiseSelecting_Reselect --filein file:PreRAWskimmed.root --fileout RAWskimmed.root -n -1 --no_exec --python_filename=selection.py
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/storage/gridka-nrg/sbrommer/gc_storage/Preselection_data_2016_CMSSW8033/TauEmbedding_Preselection_data_2016_CMSSW8033_DoubleMuon_Run2016B-v2/57/PreRAWskimmed_24756.root'),
