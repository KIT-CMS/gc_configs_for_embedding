...
process.generator.HepMCFilter.filterParameters.HadHadCut = cms.string('Had1.Pt > 20 && Had2.Pt > 20 && Had1.Eta < 2.2 && Had2.Eta < 2.2')
process.generator.HepMCFilter.filterParameters.Final_States=cms.vstring('HadHad')