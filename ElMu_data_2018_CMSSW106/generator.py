...
process.generator.HepMCFilter.filterParameters.ElMuCut = cms.string('(El.Pt > 19 && Mu.Pt > 9) || (El.Pt > 9 && Mu.Pt > 19)')
process.generator.HepMCFilter.filterParameters.Final_States=cms.vstring('ElMu')