...
process.generator.HepMCFilter.filterParameters.ElElCut = cms.string('El1.Pt > 19 && El2.Pt > 9')
process.generator.HepMCFilter.filterParameters.Final_States=cms.vstring('ElEl')
