...
# with command line options: TauAnalysis/MCEmbeddingTools/python/EmbeddingPythia8Hadronizer_cfi.py --filein file:lhe_and_cleaned.root --fileout simulated_and_cleaned_preHLT.root --conditions 106X_mcRun2_asymptotic_v15 --era Run2_2016 --eventcontent RAWSIM --step GEN,SIM,DIGI,L1,DIGI2RAW --datatier RAWSIM --customise TauAnalysis/MCEmbeddingTools/customisers.customiseGenerator_preHLT_Reselect --beamspot Realistic25ns13TeV2016Collision --no_exec -n -1 --python_filename generator_preHLT_v2.py --geometry DB:Extended --mc
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run2_2016_cff import Run2_2016

process = cms.Process('DIGI2RAW',Run2_2016)
...
#call to customisation function customiseGenerator_preHLT_Reselect imported from TauAnalysis.MCEmbeddingTools.customisers
