...
# with command line options: RECO -s RAW2DIGI,L1Reco,RECO,PAT --runUnscheduled --data --scenario pp --conditions 106X_dataRun2_v35 --era Run2_2016 --eventcontent RAWRECO --datatier RAWRECO --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run2_2016,TauAnalysis/MCEmbeddingTools/customisers.customiseSelecting_Reselect --filein file:PreRAWskimmed.root --fileout RAWskimmed.root -n -1 --no_exec --python_filename=selection_v2.py
